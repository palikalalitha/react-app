...
const DeviceContainer = styled.div `${tw`
py-4 flex flex-col items-center bg-gray-300 w-full`}`;
const Heading=styled.h1 `${tw`text-xl font-bold`}`
const ViewContainer=styled.div `${tw`   `}`
const TextArea=styled.p `${tw`w-full`}`
